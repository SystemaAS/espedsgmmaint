  ...
  jq(function() {
	  ...
	  jq('#thavdIdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavd_childwindow_syfa14r.do?action=doFind&tnealist=1' + '&ctype=thavd', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thcatsIdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thcats').val() + '&ctype=thcats', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsbIdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsb').val() + '&ctype=thtsb', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd1IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd1').val() + '&ctype=thtsd1', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd2IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd2').val() + '&ctype=thtsd2', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd3IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd3').val() + '&ctype=thtsd3', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd4IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd4').val() + '&ctype=thtsd4', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd5IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd5').val() + '&ctype=thtsd5', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd6IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd6').val() + '&ctype=thtsd6', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd7IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd7').val() + '&ctype=thtsd7', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#thtsd8IdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavdtdsncts_childwindow_generalcodes.do?action=doFind&tkunik=106' + "&tkkode=" + jq('#thtsd8').val() + '&ctype=thtsd8', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
