  ...
  jq(function() {
	  ...
	  jq('#tiavdIdLink').click(function() {
		  ...
		  window.open('mainmaintenanceavd_childwindow_syfa14r.do?action=doFind&nialist=1' + '&ctype=tiavd', "codeWin", "top=300px,left=500px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
