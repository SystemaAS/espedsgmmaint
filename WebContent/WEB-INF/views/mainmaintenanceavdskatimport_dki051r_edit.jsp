...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/mainmaintenanceavdskatimport_dki051r_edit.js?ver=${user.versionEspedsg}"></SCRIPT>	
...
<table width="100%" class="text11" cellspacing="0" border="0" cellpadding="0">
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="18%" valign="bottom" class="tabDisabled" align="center">
						<a id="alinkMainMaintAvdSadiSyftaaar" onClick="setBlockUI(this);" href="mainmaintenanceavdskatimport_dki051r.do?id=${model.id}">
	...
	<tr>
		<td>
		<%-- space separator --%>
			<form action="mainmaintenanceavdskatimport_dki051r_edit.do?id=${model.id}" name="formRecord" id="formRecord" method="POST" >
				...
				<td width="100%">
						...
						<table border="0" align="left">
				    	    ...
				    	    <tr>
				    	    	<c:choose>
					    	    	<c:when test="${not empty model.updateId}">
					    	    		<input type="hidden" name="dkia_syav" id="dkia_syav" value="${model.avd}">
										...
										<td class="text14" title="dkia_syop">&nbsp;&nbsp;&nbsp;<font class="text14RedBold" >*</font>Angiv.nr - nr.teller</td>
										<td class="text14" >
											<input onKeyPress="return numberKey(event)" type="text" class="inputTextMediumBlueMandatoryField" name="dkia_syop" id="dkia_syop" size="10" maxlength="8" value='${model.record.dkia_syop}'>
										</td>
					    	    		
					    	    	</c:when>
					    	    	<c:otherwise>
					    	    		<td class="text14" title="dkia_syav"><font class="text14RedBold" >*</font>Afdeling
					    	    			<a tabindex="-1" id="avdIdLink">
												<img style="cursor:pointer;vertical-align: middle;" src="resources/images/find.png" width="14px" height="14px" border="0" alt="search" >
											</a>
					    	    		</td>
										<td class="text14" >
										<select name="dkia_syav" id="dkia_syav" class="inputTextMediumBlueMandatoryField">
						  					<option value="">-vælg-</option>
						  					<c:forEach var="record" items="${model.avdGeneralList}" >
						 				  		<option value="${record.koaavd}"<c:if test="${ model.record.dkia_syav == record.koaavd}"> selected </c:if> >${record.koaavd}</option>
											  </c:forEach>  
											</select>
										</td>
								 		...
								 		<tr>
									 		<td width="100%">
										 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
											        ...
											        <tr>
											        	<td class="text14" align="left" >&nbsp;&nbsp;<span title="dkia_14a">CVR/SE-nr.</span></td>
											            <td class="text14" align="left" >&nbsp;<span title="dkia_14c">Navn&nbsp;</span>
											            	<a tabindex="-1" id="dkia_14c_tina_IdLink">
																<img style="cursor:pointer;vertical-align: middle;" src="resources/images/find.png" width="16px" height="16px" border="0" alt="search" >
															</a>
											            </td>
											        </tr>
											        <tr>
											            <td class="text14" align="left"><input type="text" class="inputTextMediumBlue" name="dkia_14a" id="dkia_14a" size="19" maxlength="18" value="${model.record.dkia_14a}"></td>
											            <td class="text14" align="left"><input type="text" class="inputTextMediumBlue" name="dkia_14c" id="dkia_14c" size="30" maxlength="35" value="${model.record.dkia_14c}"></td>
											        </tr>
											        
											        <tr height="4"><td>&nbsp;</td></tr>
											        <tr>
											            <td class="text14" align="left" >&nbsp;<span title="dkia_14d">Adresse</span></td>
											            <td class="text14" align="left" >&nbsp;<span title="dkia_14e">Postnr.</span></td>
											        </tr>
											        <tr>
											            <td align="left"><input type="text" class="inputTextMediumBlue" name="dkia_14d" id="dkia_14d" size="30" maxlength="35" value="${model.record.dkia_14d}"></td>
											            <td align="left"><input type="text" class="inputTextMediumBlue" name="dkia_14e" id="dkia_14e" size="10" maxlength="9" value="${model.record.dkia_14e}"></td> 
											        ...
											        <tr>
											        		<td>
												        		<table>
												        		<tr>
												            		<td class="text14" align="left" >&nbsp;<span title="dkia_14f">By</span></td>
												            		<td align="left">&nbsp;</td>
												            	</tr>
												        		<tr>
												            		<td align="left">
												       				<input type="text" class="inputTextMediumBlue" name="dkia_14f" id="dkia_14f" size="30" maxlength="35" value="${model.record.dkia_14f}">
											            			</td> 
												            		<td align="left">&nbsp;</td>
												        		</tr>    	
												            	</table>
