...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/mainmaintenanceavdskatnctsimport_dkx053r.js?ver=${user.versionEspedsg}"></SCRIPT>	
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="18%" valign="bottom" class="tabDisabled" align="center">
						<a id="alinkMainMaintAvdSkatDkx053" onClick="setBlockUI(this);" href="mainmaintenanceavdskatnctsimport_dkx053r.do?id=${model.id}">
					...
					<td width="15%" valign="bottom" class="tabDisabled" align="center">
						<a id="alinkMainMaintAvdGate" onClick="setBlockUI(this);" href="mainmaintenanceavdskatnctsimport_dkx053r_edit.do?id=${model.id}">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" align="center">
					               	<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="mainmaintenanceavdskatnctsimport_dkx053r_edit.do?avd=${record.tiavd}&updateId=${record.tiavd}&avdnavn=${record.koanvn}&id=${model.id}">
				               ...
				               <td align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="mainmaintenanceavdskatnctsimport_dkx053r_edit.do?action=doDelete&tiavd=${record.tiavd}">
