...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/mainmaintenanceavdskatimport_dki051r.js?ver=${user.versionEspedsg}"></SCRIPT>	
				...
				<table id="containerdatatableTable" width="99%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" align="center">${record.dkia_syav}</td>
				               <td width="20%" class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;">&nbsp;${record.dkia_syop}&nbsp;</td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;">&nbsp;${record.dkia_14c}&nbsp;</td>
