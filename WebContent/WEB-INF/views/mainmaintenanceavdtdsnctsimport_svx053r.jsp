...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/mainmaintenanceavdtdsnctsimport_svx053r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<table width="100%" class="text11" cellspacing="0" border="0" cellpadding="0">
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<c:choose> 
		    			<c:when test="${model.id=='SVNSTD'}">
							<td width="18%" valign="bottom" class="tabDisabled" align="center">
								<a id="alinkMainMaintAvdSkatDkx003" onClick="setBlockUI(this);" href="mainmaintenanceavdtdsnctsimport_svx053r.do?id=${model.id}">
	                       			<font class="tabLink">&nbsp;<spring:message code="systema.ncts.import.label"/></font>&nbsp;
								</a>
							</td>
	                    </c:when>
					...
					<td width="15%" valign="bottom" class="tabDisabled" align="center">
						<a id="alinkMainMaintAvdGate" onClick="setBlockUI(this);" href="mainmaintenanceavdtdsnctsimport_svx053r_edit.do?id=${model.id}">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" align="center">
					               	<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="mainmaintenanceavdtdsnctsimport_svx053r_edit.do?avd=${record.tiavd}&updateId=${record.tiavd}&avdnavn=${record.koanvn}&id=${model.id}">
				               ...
				               <td align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Är du säker på att du vill ta bort denna?')" tabindex=-1 href="TODOmainmaintenanceavdtdsnctsimport_svx003r_edit.do?action=doDelete&tiavd=${record.tiavd}">
