...
public class ExternalUrlDataStore {
	...
	//[1] FETCH L1 record
	//----------------------------
	//http://gw.systema.no/sycgip/TJL1KUND.pgm?user=JOVO&mode=G&firma=SY&kundnr=80012 
	@UrlDataStoreAnnotationForField (name="@MainMaintenanceCundfVkundController - mainmaintenancecundf_kund_edit.do ", description=" --> L1_BASE_FETCH_SPECIFIC_CUSTOMER_URL - fetch customer")
	static public String L1_BASE_FETCH_SPECIFIC_CUSTOMER_URL = AppConstants.HTTP_ROOT_CGI + "/sycgip/TJL1KUND.pgm";
